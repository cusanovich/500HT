...
all.pvals <- list.files(path = "/mnt/lustre/home/cusanovich/500HT/eQTLs/",pattern=".3chip.150kb.bonferroni.gccor.covcor.regressPCs.gemma.chosen.txt",full.names=T)
...
pvals.o = pvals[inder]
pdf("~/500HT/Scripts/gccor.covcor.regressPCs.hists.pdf")
qcounts = c()
...
dev.off()
pdf("~/500HT/Scripts/gccpr.covcor.regressPCs.eqtl.calls.pdf")
