...
snpbed = BedTool("/mnt/lustre/home/cusanovich/500HT/Imputed1415/hutt.imputed.snppos.bed")
snpbed.intersect(firstbed,c=True).saveas("/mnt/lustre/home/cusanovich/500HT/Imputed1415/hutt.imputed.dnase.bed")
titler = 'echo "chrm\tstart\tend\trsID\t' + files[0].split('/')[-1].split('.')[0] + '" | cat - /mnt/lustre/home/cusanovich/500HT/Imputed1415/hutt.imputed.dnase.bed > /mnt/lustre/home/cusanovich/500HT/Imputed1415/last_tissue.bed'
