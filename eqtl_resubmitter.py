...
for pc in range(41,81):
	...
	for chrm in range(22,0,-1):
		if os.path.isfile("/mnt/lustre/home/cusanovich/500HT/ByChr/chr" + str(chrm) + ".PC" + str(pc) + ".bonferroni.done"):
			continue
		eqtler = 'echo "python /mnt/lustre/home/cusanovich/500HT/Scripts/alt_gemma_noplink_eqtl_mapper.py chr' + str(chrm) + ' ' + str(pc) + '" | qsub -l h_vmem=1g -V -o ~/dump/ -e ~/dump/ -N "eQTLs.chr' + str(chrm) + '.PC' + str(pc) + '"'
		ifier(eqtler)
